...
const Login = (props: Props) => {
    ...
    const handleLogin = (e: React.FormEvent) => {
        ...
        if (user) {
            // Login successful, store user email in local storage
  ...
  return (
        <div className="relative flex flex-row justify-space-between min-h-screen overflow-hidden">
            ...
            <div className="w-full p-6 m-auto bg-white rounded-md shadow-xl lg:max-w-xl">
                <h1 className="text-3xl font-semibold text-center text-blue-950 uppercase">
                    Sign in
                </h1>
                <form className="mt-6" onSubmit={handleLogin}>
                    <div className="mb-2">
                        ...
                        <input
                            type="email" onChange={handleChangeEmail}
                            className="block w-full px-4 py-2 mt-2 text-blue-950 bg-white border rounded-md focus:border-blue-900 focus:ring-blue-800 focus:outline-none focus:ring focus:ring-opacity-40"
                        />
                    </div>
                    <div className="mb-2">
                        <label
                    ...
                    <div className="mt-6">
                        <button className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-blue-950 rounded-md hover:bg-blue-900 focus:outline-none focus:bg-blue-900"
                        onClick={handleLogin}>
                            Login
                        </button>
                    </div>
                ...
                <div className="flex mt-4 gap-x-2">
                    <button
                        type="button"
                        className="flex items-center justify-center w-full p-2 border border-gray-600 rounded-md focus:ring-2 focus:ring-offset-1 focus:ring-blue-800"
                    >
                        <svg
                    ...
                    <button className="flex items-center justify-center w-full p-2 border border-gray-600 rounded-md focus:ring-2 focus:ring-offset-1 focus:ring-blue-800">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 32 32"
                            className="w-5 h-5 fill-current"
